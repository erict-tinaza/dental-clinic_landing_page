    ...
    <section className="relative hero-bg h-screen">
      ...
      <div className="absolute left-1/2 transform -translate-x-1/2 bottom-0 pointer-events-none" aria-hidden="true">
        <svg width="1360" height="578" viewBox="0 0 1360 578" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient x1="50%" y1="0%" x2="50%" y2="50%" id="illustration-01">
          ...
          <div className="text-center pb-12 md:pb-16">
            ...
            <div className="max-w-3xl mx-auto">
              <p className="text-xl text-gray-700 mb-8" data-aos="zoom-y-out" data-aos-delay="150">
                It includes regular check-ups, cleanings, fillings, root-clean, extractions and cosmetic procedures like teeth whitening and orthodonics              </p>
