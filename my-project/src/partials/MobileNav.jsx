      ...
      <div ref={mobileNav}>
        ...
        >
          ...
          <li>
            ...
            <li>
              <Link href="/" className="flex font-medium w-full text-gray-600 hover:text-gray-900 py-2 justify-center" onClick={() => setMobileNavOpen(false)}>Services</Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/" className="flex font-medium w-full text-gray-600 hover:text-gray-900 py-2 justify-center" onClick={() => setMobileNavOpen(false)}>Contact</Link>
            </li>
            <li>
